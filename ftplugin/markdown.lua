...
if require("zk.util").notebook_root(vim.fn.expand('%:p')) ~= nil then
  ...
  map("v", "<leader>znt", string.format(":'<,'>ZkNewFromTitleSelection { dir = '%s' }<CR>", notes_dir), opts)
  ...
  map("v", "<leader>znc", string.format(":'<,'>ZkNewFromContentSelection { dir = '%s', title = vim.fn.input('Title: ') }<CR>", notes_dir), opts)
